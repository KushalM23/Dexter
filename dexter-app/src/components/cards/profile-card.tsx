...
function ProfileCardComponent({
  ...
  const tiltEngine = useMemo<TiltEngine | null>(() => {
    ...
    const setVarsFromXY = (x: number, y: number): void => {
      ...
      const heightValue = shell.clientHeight || 1;

      const percentX = clamp((100 / width) * x);
      const percentY = clamp((100 / heightValue) * y);
    ...
    >
      ...
      <div ref={shellRef} className="group relative z-[1]">
        <section
          ...
          onMouseLeave={(event) => {
            const shell = shellRef.current;
            event.currentTarget.style.transition = shell?.classList.contains(
              "entering",
            )
        ...
        >
          ...
          >
            ...
            >
              <div
                className="absolute inset-x-0 -bottom-px top-0 overflow-hidden"
                style={{
                  borderRadius: cardRadius,
                }}
              >
                <Image
                  className="absolute -bottom-px left-1/2 h-auto w-full will-change-transform transition-transform duration-150 ease-out"
                  src={avatarUrl}
              ...
              {showUserInfo ? (
                <div
                  className="pointer-events-auto absolute z-[2] flex items-center justify-between border border-white/10 backdrop-blur-2xl"
                  style={
                    {
                      "--ui-inset": "20px",
                      "--ui-radius-bias": "6px",
                ...
                >
                  ...
                  <button
                    className="cursor-pointer rounded-lg border border-white/10 px-4 py-3 text-xs font-semibold text-white/90 backdrop-blur-sm transition-all duration-200 ease-out hover:-translate-y-px hover:border-white/40"
            ...
            >
              <div
                ...
                style={{ top: titleOffset, display: "flex" }}
              >
                <h3
...
const ProfileCard = Object.assign(ProfileCardComponent, {
